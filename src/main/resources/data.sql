...
(23, NULL, 4, '2021-11-04 00:00:00', '2021-11-23 20:41:30', 1, 'Satyre puant', NULL, 'blanche et poreuse, inodore en elle-même. En revanche la gléba, tant qu\'elle est présente, répand une odeur pestilentielle de cadavre que l\'on sent à plusieurs mètres à la ronde avant même d\'avoir aperçu le champignon.', 'dans son premier stade, le phallus se présente sous forme d\'un œuf oblong.À la coupe, l\'œuf montre plusieurs couches en allant vers le centre : d\'abord une enveloppe externe, le péridium, puis une épaisse couche translucide et gélatineuse, puis une couche plus foncée et plus dense, la future gléba, et enfin au centre, un corps blanc, le futur stipe.\r\n\r\nChapeau de3 à 4 cm, conique, tronqué au sommet par un petit cercle, alvéolé et blanc mais entièrement recouvert au début d\'une gléba vert-olive à noirâtre. Celle-ci attire les mouches qui l\'emportent, disséminent ainsi les spores, et mettent à nu les alvéoles blanches.', NULL, '10 à 20 cm sur 2 à 4 cm de diamètre, allongé et s\'amincissant graduellement vers le haut, blanc, alvéolé, creux, caverneux et fragile - il s\'affaisse fréquemment au bout de quelques jours. Il est chaussé d\'une volve, reste de l\'œuf éclaté.', NULL, 'L\'œuf, débarrassé de sa gélatine, est comestible cru, par exemple en salade, et un goût se situant entre le radis et le raifort. Il est surtout consommé en Extrême-Orient. Une fois le champignon développé, son odeur de charogne proscrit toute utilisation culinaire.', 'satyre-puant'),
